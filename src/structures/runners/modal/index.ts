...
> implements ModalOptions<E, Fields> {
  ...
  private makeTextInputField(
    ...
    if (field.description !== undefined) label.description = field.description;
  ...
  toAPI(
    ...
    return {
      ...
      components: Object.entries(this.fields).map(
        ([name, component]): APIModalInteractionResponseCallbackComponent => {
            ...
            case ComponentType.TextInput: {
              const optionalValue =
                name in optionalValues
                  ...
                  : undefined;
              return this.makeTextInputField(name, component, optionalValue);
            }
            case ComponentType.StringSelect: {
              const optionalValue =
                name in optionalValues
                  ? (optionalValues[name] as APISelectMenuOption[] | undefined)
                  : undefined;
              return this.makeStringSelectField(name, component, optionalValue);
            }
          }
        },
      ),
